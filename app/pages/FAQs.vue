  ...
  <div class="yellow-background full-height">
    <div class="page-content-container">
      ...
      <div class="faq-container">
        <div class="faq-item">
          <p> <b>Do you have ADHD?</b> <br /> Nope. What I have is enough executive functioning that I have extra to
        ...
        <div class="faq-item">
          <p> <b>When is payment due?</b> <br /> At the very end of a session. I like to do it this way so that neither
            of us has to rely on memory or reminders. Once we've concluded our session, I will give you my venmo or
            paypal info and make sure the transaction goes through.</p>
        </div>
        <div class="faq-item">
          <p> <b>What happens in an intro session?</b> <br /> You will get a google meet link in your email. I will
            introduce myself, you will introduce yourself, and then I will ask you a series of questions to determine
            how best I can help you. It will take 20-30 minutes. There is absolutely zero preparation required on your
        ...
        <div class="faq-item">
          <p> <b>What are your qualifications for this work?</b> <br /> I could tell you I'm a certified blahblahblah,
            but personal coaching is a bit of a wild west with no clear standard. I do have a science degree from
            Columbia University, so I'm pretty smart. However, my biggest qualification is that I am a total nerd about
            ADHD. Not only have I done extensive research into causes and coping mechanisms, but I've worked with
            friends and clients to test out what works and what doesn't. I'm also a very compassionate and mindful
            person who truly enjoys helping people with brain challenges. If you're still undecided over whether I'm
